...
export default function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    const fragmentSource = `
      ...
      const vec4 lineColor = vec4(0.95, 0.12, 0.08, 1.0);
      ...
      void main() {
        ...
        vec4 lines = vec4(0.0);
        vec4 bgColor1 = vec4(0.04, 0.00, 0.01, 1.0);
        vec4 bgColor2 = vec4(0.28, 0.02, 0.02, 1.0);
    ...
    function render(startTime) {
      ...
      frameId = requestAnimationFrame(() => render(startTime))
    }

    window.addEventListener('resize', resizeCanvas)
    resizeCanvas()
    frameId = requestAnimationFrame(() => render(Date.now()))
